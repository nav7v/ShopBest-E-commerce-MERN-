    ...
    <div style={containerStyle}>
      ...
      <div style={{ overflowX: 'auto' }}>
        <table style={tableStyle}>
          ...
          <tbody>
            {users.map(u => {
              const userRole = u.userType || u.role || 'user';
              ...
              return (
                <tr key={u._id} style={rowStyle}>
                  ...
                  <td style={tdStyle}>
                    <span style={{ background: userRole === 'admin' ? 'rgba(234,88,12,0.2)' : 'rgba(16,185,129,0.2)', color: userRole === 'admin' ? '#f97316' : '#10b981', padding: '4px 8px', borderRadius: '4px', fontSize: '0.85rem', fontWeight: 'bold' }}>
